                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="font-weight-bolder mt-1 mb-1" style="font-size:18px">{{__('admin.questions')}}</h2>
                                    <p class="card-text"><span class="badge badge-pill badge-light-primary mr-1">{{ \App\Models\Question::count() }}</span></p>
                                </div>
                            </div>
                        </div>
                        <!-- Questions -->
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="font-weight-bolder mt-1 mb-1" style="font-size:18px">{{__('admin.wash_requests')}}</h2>
                                    <p class="card-text"><span class="badge badge-pill badge-light-primary mr-1">{{ \App\Models\WashRequest::count() }}</span></p>
                                </div>
                            </div>
                        </div>
                        <!-- Questions -->
