...
@section('title', __('admin.add_offer') )
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{__('admin.add_offer') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{__('admin.add_offer') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical needs-validation" action="{{ route('admin.offers.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mb-3"   >
                                                ...
                                                <input type="number" id="discount_amount" class="form-control" name="discount_amount" value="{{ old('discount_amount') }}" required/>
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                ...
                                                <select name="model_type" class="form-control" required>
                                                    ...
                                                    <option value="category" @selected(old('model_type') == 'category')>{{ __('admin.category')}}</option>
                                                    <option value="product" @selected(old('model_type') == 'product')>{{ __('admin.product')}}</option>
                                                </select>
                                            </div>
