...
@section('title', __('admin.add_attribute_value') )
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{__('admin.add_attribute_value') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="card-title">{{__('admin.add_attribute_value') }}</h2>
                                </div>
                                <div class="card-body">
                                    <form class="form form-vertical needs-validation" action="{{ route('admin.attribute_values.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 mb-3">
                                                ...
                                                <select name="attribute_id" class="form-control" required>
                                                    ...
                                                    @foreach ($attributes as $attribute)
                                                        <option value="{{ $attribute->id }}" @selected($attribute->id == old('attribute_id'))>{{ $attribute->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-12">
